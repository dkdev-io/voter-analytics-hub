...
export const Hero = () => {
  return <section className="pt-32 pb-20 px-4 md:px-6">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-3xl mx-auto">Our AI-powered tool helps you track, analyze and understand your voter contact data so you can pend less time running counts and more time contacting voters.</p>
        <Link to="/auth">
