...
export const PieChartsRow: React.FC<PieChartsRowProps> = ({
  ...
  return (
    <div id="pie-charts-row" className="grid grid-cols-1 md:grid-cols-3 gap-4 print:flex print:flex-row print:justify-between">
      {/* Chart 1: Tactics Distribution */}
      <div className="pie-chart-container print:w-1/3">
